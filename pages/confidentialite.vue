<template>
  <div class="confidentialite">
    <div class="texteConfidentialite">
      <h1>
        Politique de confidentialité
      </h1>
      <h3>
        Date de dernière mise à jour : 21 juillet 2020
      </h3>
      <p>
        La présente charte sur le respect de la vie privée (la « <b>Charte</b> ») a pour objectif de formaliser notre engagement quant au respect de la vie privée des utilisateurs du site internet <b>www.socobat-environnement.fr</b> (le « <b>Site</b> ») exploité par <b>SOCOBAT ENVIRONNEMENT</b>.
      </p>
      <p>
      ...
      <p>
        En vous enregistrant sur le Site, vous nous autorisez à traiter vos données à caractère personnel conformément à la Charte. <b>Si vous refusez les termes de cette Charte, veuillez vous abstenir d’utiliser le Site ainsi que les Services.</b>
      </p>
      <h3>
      ...
      <p>
        ...
        <ul>
          ...
          <li>réalisez une demande de devis,</li>
      ...
      <p>
        Pour obtenir plus d’information sur les cookies, vous pouvez <a href="https://www.cnil.fr/fr/site-web-cookies-et-autres-traceurs">consulter le site internet de la CNIL.</a>
      </p>
      <h3>
      ...
      <p>
        Vous pouvez contactez nos Services afin d’exercer vos droits à l’adresse électronique suivante : contact@socobat-environnement.fr ou à l’adresse postale suivante : 47 rue de la Ferme, Montreuil 93100, en joignant à votre demande une copie d’un titre d’identité.
      </p>
      <h3>
      ...
      <p>
        Pour toute question concernant vos données à caractère personnel ou si vous souhaitez supprimer votre Compte, merci de nous contacter à l’adresse postale suivante : 47 rue de la Ferme, Montreuil 93100 (en indiquant "Vie Privée - Protection des Données"), ou par email à contact@socobat-environnement.fr.
      </p>
      <h3>
        9. La Commission Nationale de l'Informatique et des Libertés ("CNIL")
      </h3>
      <p>
        Nous vous rappelons que vous pouvez contacter la CNIL directement sur le <a href="https://www.cnil.fr/fr/agir%20">site internet de la CNIL</a> ou par courrier à l’adresse suivante : Commission Nationale de l'Informatique et des Libertés (CNIL), 3 Place de Fontenoy - TSA 80715, 75334 PARIS CEDEX 07.
      </p>
    </div>
  </div>
</template>
...
export default {
  head () {
    return {
      title: 'Socobat Environnement - Politique de confidentialité - Spécialiste traitement des déchets en île de France',
      meta: [
